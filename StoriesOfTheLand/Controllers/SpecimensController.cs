...
namespace StoriesOfTheLand.Controllers
{
    public class SpecimensController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SpecimenID,specimenImagePath")] Specimen specimen)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SpecimenID,specimenImagePath")] Specimen specimen)
        {
