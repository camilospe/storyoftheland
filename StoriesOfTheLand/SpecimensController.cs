...
namespace StoriesOfTheLand
{
    public class SpecimensController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SpecimenID,EnlgishName")] Specimen specimen)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SpecimenID,EnlgishName")] Specimen specimen)
        {
